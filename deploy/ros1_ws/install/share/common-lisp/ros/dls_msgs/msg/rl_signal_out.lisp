...
(cl:defmethod kp-val ((m <rl_signal_out>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dls_msgs-msg:kp-val is deprecated.  Use dls_msgs-msg:kp instead.")
  (kp m))

(cl:ensure-generic-function 'kd-val :lambda-list '(m))
(cl:defmethod kd-val ((m <rl_signal_out>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dls_msgs-msg:kd-val is deprecated.  Use dls_msgs-msg:kd instead.")
  (kd m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<rl_signal_out>)))
  ...
  "d058233efee7504b4e269e87b453c168")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'rl_signal_out)))
  "Returns md5sum for a message object of type 'rl_signal_out"
  "d058233efee7504b4e269e87b453c168")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<rl_signal_out>)))
  ...
  (cl:format cl:nil "Header header ~%~%float64[12] desired_joint_positions~%float64[12] kp~%float64[12] kd~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'rl_signal_out)))
  "Returns full string definition for message of type 'rl_signal_out"
  (cl:format cl:nil "Header header ~%~%float64[12] desired_joint_positions~%float64[12] kp~%float64[12] kd~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
