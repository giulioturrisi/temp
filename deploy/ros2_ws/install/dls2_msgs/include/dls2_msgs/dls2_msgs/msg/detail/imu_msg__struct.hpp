...
#ifndef DLS2_MSGS__MSG__DETAIL__IMU_MSG__STRUCT_HPP_
#define DLS2_MSGS__MSG__DETAIL__IMU_MSG__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__dls2_msgs__msg__ImuMsg __attribute__((deprecated))
#else
# define DEPRECATED__dls2_msgs__msg__ImuMsg __declspec(deprecated)
#endif
...
struct ImuMsg_
{
  ...
  // pointer types
  using RawPtr =
    dls2_msgs::msg::ImuMsg_<ContainerAllocator> *;
  using ConstRawPtr =
    const dls2_msgs::msg::ImuMsg_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<dls2_msgs::msg::ImuMsg_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<dls2_msgs::msg::ImuMsg_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      dls2_msgs::msg::ImuMsg_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<dls2_msgs::msg::ImuMsg_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<dls2_msgs::msg::ImuMsg_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<dls2_msgs::msg::ImuMsg_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<dls2_msgs::msg::ImuMsg_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__dls2_msgs__msg__ImuMsg
    std::shared_ptr<dls2_msgs::msg::ImuMsg_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__dls2_msgs__msg__ImuMsg
    std::shared_ptr<dls2_msgs::msg::ImuMsg_<ContainerAllocator> const>
...
using ImuMsg =
  dls2_msgs::msg::ImuMsg_<std::allocator<void>>;
...
#endif  // DLS2_MSGS__MSG__DETAIL__IMU_MSG__STRUCT_HPP_
