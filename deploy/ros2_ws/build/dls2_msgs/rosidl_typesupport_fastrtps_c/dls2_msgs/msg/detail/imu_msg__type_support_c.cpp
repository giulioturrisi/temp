...
#include "dls2_msgs/msg/detail/imu_msg__rosidl_typesupport_fastrtps_c.h"
...
using _ImuMsg__ros_msg_type = dls2_msgs__msg__ImuMsg;
...
size_t get_serialized_size_dls2_msgs__msg__ImuMsg(
  const void * untyped_ros_message,
...
static uint32_t _ImuMsg__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_dls2_msgs__msg__ImuMsg(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dls2_msgs
size_t max_serialized_size_dls2_msgs__msg__ImuMsg(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dls2_msgs__msg__ImuMsg;
    is_plain =
      (
...
static size_t _ImuMsg__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_dls2_msgs__msg__ImuMsg(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dls2_msgs, msg, ImuMsg)() {
