...
#ifndef DLS2_MSGS__MSG__DETAIL__IMU_MSG__TRAITS_HPP_
#define DLS2_MSGS__MSG__DETAIL__IMU_MSG__TRAITS_HPP_
...
inline void to_yaml(
  const dls2_msgs::msg::ImuMsg & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const dls2_msgs::msg::ImuMsg & msg)
{
  return dls2_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<dls2_msgs::msg::ImuMsg>()
{
  return "dls2_msgs::msg::ImuMsg";
}

template<>
inline const char * name<dls2_msgs::msg::ImuMsg>()
{
  return "dls2_msgs/msg/ImuMsg";
}

template<>
struct has_fixed_size<dls2_msgs::msg::ImuMsg>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<dls2_msgs::msg::ImuMsg>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<dls2_msgs::msg::ImuMsg>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // DLS2_MSGS__MSG__DETAIL__IMU_MSG__TRAITS_HPP_
