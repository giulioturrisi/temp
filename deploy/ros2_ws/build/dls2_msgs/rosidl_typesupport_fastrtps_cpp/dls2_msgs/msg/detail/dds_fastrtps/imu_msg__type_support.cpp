...
#include "dls2_msgs/msg/detail/imu_msg__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const dls2_msgs::msg::ImuMsg & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dls2_msgs::msg::ImuMsg & ros_message)
{
  // Member: frame_id
  cdr >> ros_message.frame_id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dls2_msgs::msg::ImuMsg;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dls2_msgs::msg::ImuMsg *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dls2_msgs::msg::ImuMsg *>(
    untyped_ros_message);
...
{
  return &dls2_msgs::msg::typesupport_fastrtps_cpp::_ImuMsg__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dls2_msgs, msg, ImuMsg)() {
  return &dls2_msgs::msg::typesupport_fastrtps_cpp::_ImuMsg__handle;
}
