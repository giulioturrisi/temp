...
bool dls2_msgs__msg__imu_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dls2_msgs.msg._imu_msg.ImuMsg", full_classname_dest, 29) == 0);
  }
  dls2_msgs__msg__ImuMsg * ros_message = _ros_message;
  {  // frame_id
...
PyObject * dls2_msgs__msg__imu_msg__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("dls2_msgs.msg._imu_msg");
